...
patch_size = 10;
load(sprintf('/home/membercophy/Matteo_M/V1_ERF/V1_ERF_F_diff/aligned_V1_ERF_FE_ps%d.mat', patch_size))
...
for i = 1:length(F_conditions)
    ...
    filename = sprintf('/home/membercophy/Matteo_M/V1_ERF/V1_ERF_F_diff/ERF_OverTime_%s_family_ps%d.mat', condition_name, patch_size);
